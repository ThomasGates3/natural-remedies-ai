...
export const LandingPage: React.FC<LandingPageProps> = ({ onSearch, isLoading }) => {
  ...
  return (
    <div className="min-h-screen bg-dark-green-content text-text-light font-display">
      {/* Hero Section */}
      <section className="relative pt-32 pb-20 lg:pt-40 lg:pb-28 overflow-hidden bg-dark-green-bg">
        <div className="absolute inset-0 bg-gradient-to-br from-energetic-green/10 to-dark-green-bg -z-10"></div>
        <div className="max-w-4xl mx-auto text-center px-4">
          <h2 className="text-4xl md:text-6xl font-extrabold text-text-light tracking-tighter leading-tight">
          ...
          <form onSubmit={handleSubmit} className="mt-8 max-w-2xl mx-auto">
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-12 pr-32 py-4 text-lg bg-dark-green-content border-2 border-dark-green-bg rounded-full shadow-lg focus:ring-2 focus:ring-energetic-green focus:border-energetic-green transition-shadow duration-300 placeholder:text-text-light/40 text-text-light"
                disabled={isLoading}
                aria-label="Enter symptoms"
              />
              <button
                type="submit"
                className="absolute right-2 top-1/2 -translate-y-1/2 bg-energetic-green text-dark-green-bg font-bold px-6 py-3 rounded-full hover:bg-opacity-90 transition-transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      {/* Process Section */}
      <section className="py-20 lg:py-24 bg-dark-green-content">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <span className="text-energetic-green font-semibold">THE PROCESS</span>
            <h3 className="mt-2 text-3xl md:text-4xl font-bold text-text-light tracking-tight">
              Your Path to Natural Wellness in 3 Steps
            </h3>
          </div>

          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-8 bg-dark-green-bg/50 rounded-2xl shadow-sm">
              <div className="inline-flex items-center justify-center size-16 bg-energetic-green/10 text-energetic-green rounded-full mb-4">
                <span className="material-symbols-outlined text-4xl">edit_note</span>
              </div>
              <h4 className="text-xl font-bold text-text-light">1. Describe Your Symptoms</h4>
            ...
            <div className="p-8 bg-dark-green-bg/50 rounded-2xl shadow-sm">
              ...
              <h4 className="text-xl font-bold text-text-light">2. AI Analyzes</h4>
              <p className="mt-2 text-text-muted">
            ...
            <div className="p-8 bg-dark-green-bg/50 rounded-2xl shadow-sm">
              ...
              <h4 className="text-xl font-bold text-text-light">3. Get Recommendations</h4>
              <p className="mt-2 text-text-muted">
      ...
      {/* Trust Section */}
      <section className="py-20 lg:py-24 bg-dark-green-bg">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 grid md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-text-light">High Accuracy AI</h4>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-text-light">Vast Remedy Database</h4>
                  <p className="text-text-muted">
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-bold text-text-light">Partner Endorsements</h4>
                  <p className="text-text-muted">
          ...
          {/* Testimonial Card */}
          <div className="p-8 bg-gradient-to-br from-dark-green-content to-dark-green-bg rounded-3xl text-text-light shadow-2xl">
            <div className="aspect-[4/3] bg-dark-green-bg/50 rounded-2xl flex items-center justify-center mb-6">
              <svg className="w-3/4 h-3/4 text-energetic-green opacity-20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <p className="mt-4 text-text-dark/80">- Dr. Evelyn Reed, Naturopathic Doctor</p>
          </div>
        </div>
      </section>
    </div>
